...
public class ExtractNames {
  ...
  static public void main(String[] args) {
    ...
    //  System.out.println("Human names: " + ret[0].getValuesAsString());
   //   System.out.println("Place names: " + ret[1].getValuesAsString());
      ScoredList[] ret1 = extractNames.getProperNames("Ladakh Amazing Tour Package. Trip package to Srinagar,Sonamarg,Zozilla Pass,Nubra for 10 Days/ 9 Nights from New Delhi, India");
      System.out.println("Human names: " + ret1[0].getValuesAsString());
      System.out.println("Place names: " + ret1[1].getValuesAsString());
      ...
      ScoredList[] ret2 = names.getProperNames(
  ...
  //      ret2[0].getValuesAsString());
   //   System.out.println("Place names: " +
     //   ret2[1].getValuesAsString());
    }
  }
