...
import section3_recipe3.Counter;
import section3_recipe3.Person;
import section3_recipe3.PersonGenerator;
...
public class Main {
	public static void main(String[] args) {
		...
		ConcurrentMap<String, String> nameMap = persons.parallelStream().collect(Collectors.toConcurrentMap(p -> p.getFirstName(), p -> p.getLastName(), (s1, s2) -> s1 + ", " + s2));
